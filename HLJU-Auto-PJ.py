...
# 需要下载selenium，anoconda
# saov修改
# 前学长写的代码不兼容高版本的浏览器所以我稍微改了一下
...
class HLJU_AutoPJ:
    def __init__(self):
        ...
        time.sleep(1)
        self.driver.find_element(By.ID, "dlan").click()
        self.driver.find_element(By.LINK_TEXT, "学习体验调查与评教").click()
        self.xspj_start()
        time.sleep(1)
        self.xxtydc_start()

    def xspj_start(self):
        pingkes = self.driver.find_elements(By.XPATH,
